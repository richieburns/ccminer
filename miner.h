...
extern int scanhash_parallax(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_parallax(int thr_id);
...
void parallax_hash(void *output, const void *input);
